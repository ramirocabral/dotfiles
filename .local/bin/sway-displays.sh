...
if echo "$outputs" | jq -e '.[] | select(.name=="DP-3")' >/dev/null; then
    ...
    # swaymsg 'output DVI-I-2 mode 1920x1080@60Hz position 2560 0 transform 90'
    # swaymsg 'output HDMI-A-1 mode 2560x1440@60Hz position 1920 0'
    swaymsg 'output eDP-1 disable'
    swaymsg 'output DVI-I-1 mode 2560x1440@120Hz'
    swaymsg 'output DVI-I-2 mode 1920x1080@70Hz position 2560 0 transform 90'
fi
